...
<link type="text/css" rel="stylesheet" href="static/js/bootstrap.css">
...
<div style="width: 100%;height:160px;background-image: url('static/images/bg3.png')">
...
<div style="height: 100%;width: 100%">
    <div class="container" style="margin-top: -60px;background:rgba(255,255,255,.2);height: 600px;box-shadow:5px 5px 8px 2px #666;" >
        <img src="static/images/sd3.png" class="position-absolute">
