...
<div style="width: 100%;height:160px;background-image: url(${pageContext.request.contextPath}/images/bg3.png)">
    <h1 class="text-center text-primary">修改比赛申请</h1>
</div>
    ...
    const app = new Vue({
        ...
        data(){
            return{
                ...
                equipments:[],
                judgename:'${competition.cjudge}',
                competitionname:'${competition.cname}',
            }
        ...
        methods:{
            ...
            doApplication(){
                ...
                params.append("competitionid",${competition.competitionid})
                axios.post('${pageContext.request.contextPath}/competition/updateCompetitionApplication',params).then(response=>{
